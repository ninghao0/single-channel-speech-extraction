...
class NnetComputer(object):
    ...
    def _load_nnet(self, cpt_dir, nnet_conf):
        ...
        cpt = th.load(cpt_fname, map_location="cuda:0")
...
if __name__ == "__main__":
    ...
    parser.add_argument("--checkpoint",default="SpEx1/$checkpoint", type=str, help="Directory of checkpoint")
    parser.add_argument(
        "--input", default="SpEx1/mydata/tt-plus/mix_0.scp", type=str, help="Script for input waveform")
    parser.add_argument(
        "--input_aux", default="SpEx1/mydata/tt-plus/_aux.scp", type=str, help="Script for input reference waveform")
    parser.add_argument(
    ...
    parser.add_argument(
        "--output_dir", type=str, default="SpEx1/SNR=0/spex",
