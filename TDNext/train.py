...
from nnet.TDNext import TDNext
...
def run(args):
    ...
    tr_aux_scp = os.path.join(args.train_dir, "_aux.scp")


    dev_mix_scp = os.path.join(args.dev_dir, "mix.scp")
    dev_ref_scp = os.path.join(args.dev_dir, "ref.scp")
    dev_aux_scp = os.path.join(args.dev_dir, "_aux.scp")
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description=
        "Command to start TDNext training",
    ...
    parser.add_argument("--checkpoint",
                        type=str,
                        default="TDNext/$checkpoint",  # default="/checkpoint",
    ...
    parser.add_argument("--spk_embed_dim_s",
                        type=int,
                        default=0, #256
                        help="Speaker embedding dimension.")
